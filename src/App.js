                ...
                <Container title="Places I've Worked">
                    <div className={`${styles.contain} ${styles.slider}`}>
                        <div className={styles.leftTh}>
                            <div className={styles.company}>Ovis Technologies</div>
                            <div className={styles.company}>Element Zero</div>
                            <div className={styles.company}>LaGuardia Community College</div>
                        </div>
                        <div className={styles.right}>
